...
public static partial class MessageTemplateSystemNames
{
    ...
    public const string RecurringOrderStoreNotification = "Orders.RecurringOrderStoreNotification";

    public const string RecurringOrderCustomerNotification = "Orders.RecurringOrderCustomerNotification";

    public const string RecurringOrderCancelledStoreNotification = "Orders.RecurringOrderCancelledStoreNotification";

    public const string RecurringOrderCancelledCustomerNotification = "Orders.RecurringOrderCancelledCustomerNotification";

    #endregion

    #region Rewards certificates

    public const string RewardsCertificateNotification = "GiftCard.RewardsCertificateNotification";

    public const string RewardsCertificateCloseToExpirationNotification = "GiftCard.RewardsCertificateCloseToExpirationNotification";

    public const string FailedCertificateNotification = "GiftCard.FailedCertificateNotification";
