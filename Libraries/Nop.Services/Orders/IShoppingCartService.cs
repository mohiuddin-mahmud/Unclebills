...
public partial interface IShoppingCartService
{
    ...
    event MyEventHandler UpdateRecurringOrderSubscription;

    void AddRecurringOrderProductToCart(Customer customer, int storeId);

    Task RemoveRecurringOrderProductFromCart(Customer customer);
}