...
public partial interface IWorkflowMessageService
{
    ...
    Task<IList<int>> SendRecurringOrderStoreNotification(RecurringOrder recurringOrder, int languageId, List<ShoppingCartItem> items, Order initialOrder);
    Task<IList<int>> SendRecurringOrderCustomerNotification(RecurringOrder recurringOrder, int languageId, List<ShoppingCartItem> items, Order initialOrder);
    Task<IList<int>> SendRecurringOrderCancelledStoreNotification(RecurringOrder recurringOrder, int languageId, List<ShoppingCartItem> items, Order initialOrder);
    Task<IList<int>> SendRecurringOrderCancelledCustomerNotification(RecurringOrder recurringOrder, int languageId, List<ShoppingCartItem> items, Order initialOrder);
