...
public partial record ShoppingCartModel : BaseNopModel
{
    public ShoppingCartModel()
    {
        ...
        RecurringOrderData = new RecurringOrderDataModel();
    ...
    public bool DisableUpdateRecurringOrder { get; set; }
    ...
    public RecurringOrderDataModel RecurringOrderData { get; set; }
    ...
    public partial record ShoppingCartItemModel : BaseNopEntityModel
    {
        ...
        public bool OfferSubstituteProducts { get; set; }

        public IList<Product> SubstituteProducts { get; set; }
    ...
    public partial record OrderReviewDataModel : BaseNopModel
    {
        public OrderReviewDataModel()
        {
            ...
            this.RecurringOrderContext = new RecurringOrderContext();
        }
        public bool Display { get; set; }
    ...
    public partial record RecurringOrderDataModel : BaseNopModel
    {
        ...
        public System.DateTime NextOrderUtc { get; set; }
