...
public partial class CustomerModelFactory : ICustomerModelFactory
{
        ...
        bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
    {
        ...
        //recurring order
        RecurringOrdersModel recurringOrders = new RecurringOrdersModel();
        recurringOrders.RecurringOrders = _recurringOrderService.GetRecurringOrdersByCustomerGuid(customer.CustomerGuid);
        model.RecurringOrders = recurringOrders;
