...
namespace NopValley.Plugins.Misc.Models.Catalog;
...
public partial record ProductDetailsModel : BaseNopEntityModel
{
    public ProductDetailsModel()
    {
        ...
        AvailableLocations = new List<LocationNameToUrlMap>();
        ProductSizes = new List<SizeProduct>();
    }
    ...
    public string GrainFree { get; set; }
    public string ExpandsTo { get; set; }
    public string FrequentBuyer { get; set; }
    public List<int> LinkedProducts { get; set; }
    public List<LocationNameToUrlMap> AvailableLocations { get; set; }

    public IList<SizeProduct> ProductSizes { get; set; }


    #region Nested Classes

    public class LocationNameToUrlMap
    {
    ...
    public partial record AddToCartModel : BaseNopModel
    {
        public AddToCartModel()
        {
           ...
           // this.RecurringOrdersModel = new ShoppingCart.RecurringOrdersModel();
        }
        public int ProductId { get; set; }
       ...
       // public Nop.Web.Models.ShoppingCart.RecurringOrdersModel RecurringOrdersModel { get; set; }
    }
