...
public partial class JsonLdModelFactory : IJsonLdModelFactory
{
    ...
    /// </returns>
    protected virtual async Task<JsonLdBreadcrumbListModel> PrepareJsonLdBreadcrumbListAsync(IList<Nop.Web.Models.Catalog.CategorySimpleModel> categoryModels)
    {
    ...
    /// The task result contains JSON-LD category breadcrumb model
    /// </returns>
    public virtual async Task<JsonLdBreadcrumbListModel> PrepareJsonLdCategoryBreadcrumbAsync(IList<Nop.Web.Models.Catalog.CategorySimpleModel> categoryModels)
    {
