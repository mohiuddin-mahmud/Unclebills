...
using NopValley.Plugins.Misc.Models.Catalog;
...
public partial class CustomProductModelFactory : ICustomProductModelFactory
{
    ...
    protected readonly NopValley.Plugins.Misc.Factories.IJsonLdModelFactory _jsonLdModelFactory;
    ...
    public CustomProductModelFactory(CaptchaSettings captchaSettings,
        ...
        NopValley.Plugins.Misc.Factories.IJsonLdModelFactory jsonLdModelFactory,
    ...
    protected virtual async Task PrepareGroupedProductPriceModelAsync(Product product, Nop.Web.Models.Catalog.ProductPriceModel priceModel)
    {
    ...
    /// </returns>
    protected virtual async Task<Nop.Web.Models.Catalog.ProductPriceModel> PrepareProductPriceModelAsync(Product product, bool addPriceRangeFrom = false, bool forceRedirectionAfterAddingToCart = false)
    {
        ArgumentNullException.ThrowIfNull(product);

        var currentCurrency = await _workContext.GetWorkingCurrencyAsync();

        var model = new Nop.Web.Models.Catalog.ProductPriceModel
        {
    ...
    /// </returns>
    protected virtual async Task<IList<Nop.Web.Models.Catalog.ProductSpecificationAttributeModel>> PrepareProductSpecificationAttributeModelAsync(Product product, SpecificationAttributeGroup group)
    {
        ArgumentNullException.ThrowIfNull(product);
        ...
        var result = new List<Nop.Web.Models.Catalog.ProductSpecificationAttributeModel>();
        ...
        foreach (var psa in productSpecificationAttributes)
        {
            ...
            if (model == null)
            {
                ...
                model = new Nop.Web.Models.Catalog.ProductSpecificationAttributeModel
                {
                    Id = attribute.Id,
            ...
            var value = new Nop.Web.Models.Catalog.ProductSpecificationAttributeValueModel
            {
    ...
    /// </returns>
    protected virtual async Task<Nop.Web.Models.Catalog.ProductReviewOverviewModel> PrepareProductReviewOverviewModelAsync(Product product)
    {
        Nop.Web.Models.Catalog.ProductReviewOverviewModel productReview;
        ...
        if (_catalogSettings.ShowProductReviewsPerStore)
        {
            ...
            productReview = await _staticCacheManager.GetAsync(cacheKey, async () =>
            {
                ...
                return new Nop.Web.Models.Catalog.ProductReviewOverviewModel
                {
        ...
        {
            productReview = new Nop.Web.Models.Catalog.ProductReviewOverviewModel
            {
    ...
    protected virtual async Task<ProductDetailsModel.ProductBreadcrumbModel> PrepareProductBreadcrumbModelAsync(Product product)
    {
        ...
        {
            breadcrumbModel.CategoryBreadcrumb.Add(new Nop.Web.Models.Catalog.CategorySimpleModel
            {
                Id = catBr.Id,
    ...
    /// </returns>
    protected virtual async Task<IList<Nop.Web.Models.Catalog.ProductTagModel>> PrepareProductTagModelsAsync(Product product)
    {
        ArgumentNullException.ThrowIfNull(product);
        ...
        var model = await productsTags
            ...
            .SelectAwait(async x => new Nop.Web.Models.Catalog.ProductTagModel
            {
                Id = x.Id,
    ...
    /// </returns>
    protected virtual async Task<IList<Nop.Web.Models.Catalog.ManufacturerBriefInfoModel>> PrepareProductManufacturerModelsAsync(Product product)
    {
        ArgumentNullException.ThrowIfNull(product);
        ...
        var model = await (await _manufacturerService.GetProductManufacturersByProductIdAsync(product.Id))
            .SelectAwait(async pm =>
            {
                ...
                var modelMan = new Nop.Web.Models.Catalog.ManufacturerBriefInfoModel
                {
                    Id = manufacturer.Id,
    ...
    /// </returns>
    public virtual async Task<IEnumerable<Nop.Web.Models.Catalog.ProductOverviewModel>> PrepareProductOverviewModelsAsync(IEnumerable<Product> products,
        ...
        bool forceRedirectionAfterAddingToCart = false)
    {
        ...
        var models = new List<Nop.Web.Models.Catalog.ProductOverviewModel>();
        foreach (var product in products)
        {
            var model = new Nop.Web.Models.Catalog.ProductOverviewModel
            {
                Id = product.Id,
    ...
    /// </returns>
    public virtual async Task<IList<Nop.Web.Models.Catalog.ProductCombinationModel>> PrepareProductCombinationModelsAsync(Product product)
    {
        ArgumentNullException.ThrowIfNull(product);

        var result = new List<Nop.Web.Models.Catalog.ProductCombinationModel>();
        ...
        if (combinations?.Any() == true)
        {
            ...
            {
                var combinationModel = new Nop.Web.Models.Catalog.ProductCombinationModel
                {
                ...
                {
                    var attributeModel = new Nop.Web.Models.Catalog.ProductAttributeModel
                    {
                        Id = mapping.Id
                    };
    ...
    /// </returns>
    public virtual async Task<NopValley.Plugins.Misc.Models.Catalog.ProductDetailsModel> PrepareProductDetailsModelAsync(Product product,
        ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
    {
        ...
        if (_vendorSettings.ShowVendorOnProductDetailsPage)
        {
            ...
            if (vendor != null && !vendor.Deleted && vendor.Active)
            {
                ...
                model.VendorModel = new Nop.Web.Models.Catalog.VendorBriefInfoModel
                {
                    Id = vendor.Id,
    ...
    /// </returns>
    public virtual async Task<Nop.Web.Models.Catalog.ProductReviewsModel> PrepareProductReviewsModelAsync(Product product)
    {
        ArgumentNullException.ThrowIfNull(product);

        var model = new Nop.Web.Models.Catalog.ProductReviewsModel
        {
            ProductId = product.Id
        };
        ...
        {
            model.ReviewTypeList.Add(new Nop.Web.Models.Catalog.ReviewTypeModel
            {
                Id = reviewType.Id,
        ...
        foreach (var pr in productReviews)
        {
            ...
            var productReviewModel = new Nop.Web.Models.Catalog.ProductReviewModel
            {
                Id = pr.Id,
                ...
                Rating = pr.Rating,
                Helpfulness = new Nop.Web.Models.Catalog.ProductReviewHelpfulnessModel
                {
            ...
            foreach (var q in await _reviewTypeService.GetProductReviewReviewTypeMappingsByProductReviewIdAsync(pr.Id))
            {
                ...
                productReviewModel.AdditionalProductReviewList.Add(new Nop.Web.Models.Catalog.ProductReviewReviewTypeMappingModel
                {
        ...
        foreach (var rt in model.ReviewTypeList)
        {
            ...
            var reviewTypeMappingModel = new Nop.Web.Models.Catalog.AddProductReviewReviewTypeMappingModel
            {
                ReviewTypeId = rt.Id,
                Name = await _localizationService.GetLocalizedAsync(reviewType, entity => entity.Name),
                Description = await _localizationService.GetLocalizedAsync(reviewType, entity => entity.Description),
    ...
    /// </returns>
    public virtual async Task<Nop.Web.Models.Catalog.CustomerProductReviewsModel> PrepareCustomerProductReviewsModelAsync(int? page)
    {
        ...
        var productReviews = new List<Nop.Web.Models.Catalog.CustomerProductReviewModel>();

        foreach (var review in list)
        {
            var product = await _productService.GetProductByIdAsync(review.ProductId);

            var productReviewModel = new Nop.Web.Models.Catalog.CustomerProductReviewModel
            {
                Title = review.Title,
                ProductId = product.Id,
        ...
        var pagerModel = new PagerModel(_localizationService)
        {
            ...
            UseRouteLinks = true,
            RouteValues = new Nop.Web.Models.Catalog.CustomerProductReviewsModel.CustomerProductReviewsRouteValues { PageNumber = pageIndex }
        };

        var model = new Nop.Web.Models.Catalog.CustomerProductReviewsModel
        {
    ...
    /// </returns>
    public virtual async Task<Nop.Web.Models.Catalog.ProductEmailAFriendModel> PrepareProductEmailAFriendModelAsync(Nop.Web.Models.Catalog.ProductEmailAFriendModel model, Product product, bool excludeProperties)
    {
    ...
    /// </returns>
    public virtual async Task<Nop.Web.Models.Catalog.ProductSpecificationModel> PrepareProductSpecificationModelAsync(Product product)
    {
        ArgumentNullException.ThrowIfNull(product);

        var model = new Nop.Web.Models.Catalog.ProductSpecificationModel();

        // Add non-grouped attributes first
        model.Groups.Add(new Nop.Web.Models.Catalog.ProductSpecificationAttributeGroupModel
        {
