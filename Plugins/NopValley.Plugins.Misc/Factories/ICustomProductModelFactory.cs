...
/// </summary>
public partial interface ICustomProductModelFactory
{
    /// <summary>
    ...
    /// </returns>
    Task<IEnumerable<Nop.Web.Models.Catalog.ProductOverviewModel>> PrepareProductOverviewModelsAsync(IEnumerable<Product> products,
    ...
    /// </returns>
    Task<IList<Nop.Web.Models.Catalog.ProductCombinationModel>> PrepareProductCombinationModelsAsync(Product product);
    ...
    /// </returns>
    Task<Models.Catalog.ProductDetailsModel> PrepareProductDetailsModelAsync(Product product, ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false);
    ...
    /// </returns>
    Task<Nop.Web.Models.Catalog.ProductReviewsModel> PrepareProductReviewsModelAsync(Product product);
    ...
    /// </returns>
    Task<Nop.Web.Models.Catalog.CustomerProductReviewsModel> PrepareCustomerProductReviewsModelAsync(int? page);
    ...
    /// </returns>
    Task<Nop.Web.Models.Catalog.ProductEmailAFriendModel> PrepareProductEmailAFriendModelAsync(Nop.Web.Models.Catalog.ProductEmailAFriendModel model, Product product, bool excludeProperties);
    ...
    /// </returns>
    Task<Nop.Web.Models.Catalog.ProductSpecificationModel> PrepareProductSpecificationModelAsync(Product product);
}