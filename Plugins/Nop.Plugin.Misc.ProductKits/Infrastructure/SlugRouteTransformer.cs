...
//            case var name when name.Equals(nameof(ServicePost), StringComparison.InvariantCultureIgnoreCase):
//                RouteToAction(values, "ServicePost", "ServicePost", slug, (NopRoutingDefaults.RouteValue.ServicePostId, urlRecord.EntityId));
//                return;
//        }
//    }
